//para estos tests tengo que llamar a mocha con ./app.test.js --exit, porque sino sigue corriendo el servidor
...
describe('app', () => {
    ...
    context('handleError', () => {
        ...
        it('shoudl check error instance and format message', (done) => {
        ...
        it('should return object witouth changing it if not instance of error', (done) => {
